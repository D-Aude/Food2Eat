...
/* Date de création :  02/08/2018 15:59:12                      */
/*==============================================================*/
...
INSERT INTO Produit (id_mode_conservation, id_categorie, id_mesure, nom_produit, nombre_unite, date_proposition, date_activation, date_desactivation) VALUES (1, 16, 1, 'Camembert 250g Cœur de Lion', '100', '2018-07-01', '2018-07-02', NULL);
...
/*------------------ANNONCE ---------------------*/
insert into Annonce (Id_stock,Id_adresse,Id_annulation,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_annulation) values ('1','1','1','2018/07/20','2018/07/22','2018/07/24','2018/07/25','2018/07/25');
insert into Annonce (Id_stock,Id_adresse,Titre,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('2','2','Je pars en vacances vite !','2018/03/05','2018/03/09','2018/03/10','2018/03/11','2018/03/09');
insert into Annonce (Id_stock,Id_adresse,Titre,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('5','3','Les vacances arrivent …','2018/02/21','2018/02/20','2018/02/22','2018/02/25','2018/02/22');
insert into Annonce (Id_stock,Id_adresse,Id_annulation,Titre,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_annulation) values ('6','3','2','Départ précipté ','2018/04/15','2018/04/16','2018/04/17','2018/04/21','2018/04/18');
insert into Annonce (Id_stock,Id_adresse,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('7','5','2018/07/27','2018/07/28','2018/08/01','2018/08/07','2018/08/07');
insert into Annonce (Id_stock,Id_adresse,Titre,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('9','6','Pas de gaspillage!','2018/04/21','2018/04/22','2018/04/25','2018/04/26','2018/04/26');
insert into Annonce (Id_stock,Id_adresse,Titre,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('10','7','Vite vite','2018/08/04','2018/08/05','2018/08/09','2018/08/10','2018/08/10');
insert into Annonce (Id_stock,Id_adresse,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('11','7','2018/08/03','2018/08/05','1018/08/09','2018/08/10','2018/08/10');
insert into Annonce (Id_stock,Id_adresse,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3) values ('14','1','2018/07/30','2018/08/02','2018/08/05','2018/08/12');
insert into Annonce (Id_stock,Id_adresse,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3) values ('14','1','2018/08/04','2018/08/08','2018/08/12','2018/08/17');
insert into Annonce (Id_stock,Id_adresse,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3) values ('8','1','2018/07/22','2018/07/28','2018/08/03','2018/08/07');
insert into Annonce (Id_stock,Id_adresse,Titre,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('10','7','Vite vite','2018/08/04','2018/08/05','2018/08/09','2018/08/10','2018/08/10');
insert into Annonce (Id_stock,Id_adresse,Date_publication,Date_rdv_1,Date_rdv_2,Date_rdv_3,Date_fin_annonce) values ('12','7','2018/07/23','2018/07/25','2018/07/29','2018/07/30','2018/08/01');

/*------------------REPONSE ---------------------*/
insert into RepAnnonce ( Id_utilisateur,Id_annonce,Date_reponse,Date_acceptation_reponse,Date_RDV) values ( '6','3','2018/02/20','2018/02/21','2018/02/22');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_RDV,Date_refus) values ( '5','3','2018/02/21','2018/02/25','2018/02/21');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_RDV,Date_annulation_reponse) values ( '4','5','2018/07/28','2018/08/01','2018/08/02');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_acceptation_reponse,Date_RDV) values ( '3','6','2018/08/01','2018/08/05','2018/08/07');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_acceptation_reponse,Date_RDV) values ( '2','8','2018/08/02','2018/08/03','2018/08/10');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_acceptation_reponse,Date_RDV) values ( '1','2','2018/03/06','2018/03/08','2018/03/09');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_RDV,Date_refus) values ( '6','3','2018/03/07','2018/08/25','2018/03/10');
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_acceptation_reponse,Date_RDV) values ( '5','7','2018/08/08','2018/08/08','2018/08/10');
...
insert into RepAnnonce (Id_utilisateur,Id_annonce,Date_reponse,Date_acceptation_reponse,Date_RDV) values ( '5','13','2018/07/24','2018/07/25','2018/07/30');

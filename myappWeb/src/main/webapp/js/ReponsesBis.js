...
var annoncesAvecReponses = new Vue({
	  ...
	  created: function() {
		var vm = this
	    axios.get('http://localhost:8080/myappWeb/services/rest/mesAnnoncesPostees/reponsesRecues/' + vm.iduser)
...
var reponsesAnnonce = new Vue({
	  ...
	  methods: { 
		...
		voirReponses: function(idAnnonce) {
